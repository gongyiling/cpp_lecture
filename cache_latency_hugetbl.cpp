...
int main(int argc, char* argv[])
{
	...
	const int N = 1024 * 1024 * 16 / sizeof(Node);
	Node* va = (Node*)mmap(NULL, N * sizeof(Node), PROT_READ | PROT_WRITE, MAP_ANONYMOUS | MAP_HUGETLB | MAP_PRIVATE, -1, 0);
	if (va == MAP_FAILED)
	{
